    ...
    <div class="carousel-inner">
        <div class="item" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                ...
                <p> Do a Kick Flip or some serious Technical Skating on Motion Board Rock-On!</p>
            </div>
        </div>
        <div class="item" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                <h3> Carve </h3>
                <p> Carve your new style on Motion Board Rock-On!</p>
            </div>
        </div>
        ...
        <div class="item active" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                <h3>Pro Skate Board Motion Rock-On!</h3>
                <p> Do all your cool stuff on Contoso board Motion Rock-On!</p>
            </div>
        </div>
    </div>
<!-- Controls -->
